...
При замене готового каталога сборщик сохраняет его прежнее содержимое в соседней
резервной папке до установки нового снимка. Если установка не удалась, прежний
каталог восстанавливается. Если восстановление также заблокировано, ошибка
указывает путь сохранённой копии; оставьте её для восстановления. Если не удалось
только удалить резервную папку, сообщение явно сообщает, что новый снимок уже
установлен. Замена каталогов не атомарна: читатель может кратковременно не найти
выходной каталог, поэтому не пересобирайте каталог, из которого обслуживаются клиенты.
